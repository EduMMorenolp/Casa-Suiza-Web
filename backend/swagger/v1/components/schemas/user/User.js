...
const User = {
  ...
  properties: {
    id: {
      ...
      example: "57940ceb-43c2-4f73-ba9c-9f62572147c9",
    },
    username: {
      type: "string",
    ...
    is_deleted: {
      type: "boolean",
      description:
        "Estado de eliminación del usuario (si está marcado como eliminado)",
      example: false,
    },
    role: {
      type: "string",
      description:
        "Rol del usuario dentro del sistema (usuario común o administrador)",
      enum: ["user", "admin"],
      example: "user",
    },
  },
